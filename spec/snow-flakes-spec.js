...
import SnowFlakes from '../lib/snow-flakes';
  ...
  describe('when the snow-flakes:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let snowFlakesElement = workspaceElement.querySelector('.snow-flakes');
        expect(snowFlakesElement).toExist();

        let snowFlakesPanel = atom.workspace.panelForItem(snowFlakesElement);
